...
class Modal extends Component {
    ...
    render() {
        return (
            <div className="modal fade" id={this.props.id} tabIndex="0" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" style={{ fontSize: '10px', padding: '5px 10px', color: 'white', background: '#003F8A', borderRadius: '15px', width: "18%", verticalAlign: 'center' }} data-dismiss="modal" onClick={this.props.handleSubmit}>{this.props.id === "exampleModal" ?  "Add Criteria" : "Save Change" }</button>
                        </div>
                    </div>
                </div>
            </div>
