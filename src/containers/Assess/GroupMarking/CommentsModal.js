                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <CommentsList comments={this.props.comments[this.props.content]} target = {this.props.target} upItem = {this.props.updateItem} setId = {this.props.setId} id = {this.props.id} updateItem={this.props.updateItem} />
                        </div>
